...
library(ggplot2)
EC <- read.csv('BC_region.csv',header = T)  ## 读取我们的数据
...
EC_1990$val <- round(EC_1990$val,2)  ###取整
EC_1990$lower <- round(EC_1990$lower,2)###取整
EC_1990$upper <- round(EC_1990$upper,2) ###取整
...
EC_2019$val <- round(EC_2019$val,2)  ###取整
EC_2019$lower <- round(EC_2019$lower,2)###取整
EC_2019$upper <- round(EC_2019$upper,2) ###取整
...
ASR_2019$val <- round(ASR_2019$val,2)  ###取整
ASR_2019$lower <- round(ASR_2019$lower,2)###取整
ASR_2019$upper <- round(ASR_2019$upper,2) ###取整
